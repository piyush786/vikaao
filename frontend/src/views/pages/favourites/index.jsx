...
import { getFavProducts } from './actions';
...
class Index extends Component {
  ...
  componentDidMount() {
    this.props.getFavProducts()
  }

  changeView(view) {
    this.setState({ ...this.state, listType: view })
  }

  productsParam(data) {
    this.setState({ ...this.state, productParam: { ...this.state.productParam, ...data } }, () => {
      this.props.getFavProducts({ ...this.state.productParam, ...data })
    })
  }
          ...
          <div className="container">
            <div className="row padding-div">
              <div className="col-md-12">
                <br />
                <h3 className="main-title">My Favourite Products</h3>
...
const mapStateToProps = (state) => {
  return {
    products: state.favProductReducer.products
  };
};

const mapDispatchToProps = (dispatch) => ({
  getFavProducts: (data) => dispatch(getFavProducts(data)),
});
